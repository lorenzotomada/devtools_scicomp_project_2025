# This script is supposed to be called while in the root folder of the project, using the command "./shell/submit.sh".
# I decided not to write #!/bin/bash for compatibility reasons.
# It might be needed to call chmod +x shell/submit.sh in order to execute the script properly.
